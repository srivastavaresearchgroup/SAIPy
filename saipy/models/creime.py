...
class CREIME:
    def __init__(self):
        self.model = keras.models.load_model('../saipy/saved_models/CREIME.h5', custom_objects = {'custom_loss2': custom_loss2})
...
class CREIME_RT:
    def __init__(self):
        with open('../saipy/saved_models/CREIME_RT.json', 'r') as json_file:
            json_savedModel= json_file.read()
        #load the model architecture 
        self.model = tf.keras.models.model_from_json(json_savedModel,
                                                     custom_objects = {'SeqSelfAttention': SeqSelfAttention,
                                                                       'FeedForward': FeedForward})
        self.model.load_weights('../saipy/saved_models/CREIME_RT.h5')
