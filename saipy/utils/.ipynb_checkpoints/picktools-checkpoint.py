...
def phase_picking2(device, model, X_data, picker_num_shift, batch_size):
    ...
    sliding_E = sliding_window(X_data[:,0], n_feat, stepsize=picker_num_shift)
    sliding_N = sliding_window(X_data[:,1], n_feat, stepsize=picker_num_shift)
    sliding_Z = sliding_window(X_data[:,2], n_feat, stepsize=picker_num_shift)
...
# ________ Old version v1_______________________________________
